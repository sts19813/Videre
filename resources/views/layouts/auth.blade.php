...
<head>
    ...
    <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo2/authentication/classic/sign-in/index.html"
        rel="canonical" />
    ...
    <meta content="/metronic/assets/media/app/og-image.png" name="twitter:image" />
    <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo2/authentication/classic/sign-in/index.html"
        property="og:url" />
    ...
    <meta content="/metronic/assets/media/app/og-image.png" property="og:image" />
    <link href="/metronic/assets/media/app/apple-touch-icon.png" rel="apple-touch-icon" sizes="180x180" />
    <link href="/metronic/assets/media/app/favicon-32x32.png" rel="icon" sizes="32x32" type="image/png" />
    <link href="/metronic/assets/media/app/favicon-16x16.png" rel="icon" sizes="16x16" type="image/png" />
    <link href="/metronic/assets/media/app/favicon.ico" rel="shortcut icon" />
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet" />
    <link href="/metronic/assets/vendors/apexcharts/apexcharts.css" rel="stylesheet" />
    <link href="/metronic/assets/vendors/keenicons/styles.bundle.css" rel="stylesheet" />
    <link href="/metronic/assets/css/styles.css" rel="stylesheet" />
</head>
...
<body class="antialiased flex h-full text-base text-foreground bg-background">
            ...
            <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="sign_in_form" method="get">
                <div class="text-center mb-2.5">
                    ...
                    <div class="flex items-center justify-center font-medium">
                        ...
                        <a class="text-sm link" href="html/demo2/authentication/classic/sign-up.html">
                            Sign up
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex items-center justify-between gap-1">
                        ...
                        <a class="text-sm kt-link shrink-0"
                            href="html/demo2/authentication/classic/reset-password/enter-email.html">
                            Forgot Password?
                        </a>
                    </div>
    ...
    <!-- End of Page -->
    <!-- Scripts -->
    <script src="/metronic/assets/js/core.bundle.js">
    </script>
    <script src="/metronic/assets/vendors/ktui/ktui.min.js">
    </script>
    <script src="/metronic/assets/vendors/apexcharts/apexcharts.min.js">
    </script>
    <!-- End of Scripts -->
</body>
