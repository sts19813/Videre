                                    ...
                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="html/demo2/account/home/settings-sidebar.html">
                                                <span class="kt-menu-icon">
                            ...
                            <div class="flex items-center grow gap-2.5 px-5">
                                ...
                                <div class="flex flex-col gap-1">
                                    <span class="text-sm font-medium text-secondary-foreground">
                                        You have succesfully verified your
                                        account
                                    </span>
                                    <span class="font-medium text-muted-foreground text-xs">
                                        2 days ago
                                    ...
                                    <div class="kt-card shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg bg-muted/70">
                                        <div class="text-sm font-semibold text-secondary-foreground mb-px">
                                            ...
                                            <span class="text-secondary-foreground font-medium">
                                                This
                                                design is simply
                                                stunning! From layout
                                                to color, it's a work
                                                of art!
                                            </span>
                                        </div>
                                        <div class="kt-input">
                                ...
                                <div class="kt-menu" data-kt-menu="true">
                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px"
                                        ...
                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]"
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="html/demo2/account/security/privacy-settings.html">
                                                    <span class="kt-menu-icon">
                    ...
                    <div class="flex flex-col gap-5 py-5">
                        <div class="flex items-end gap-3.5 px-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <div
                                    ...
                                    Next week we are closing the project. Do
                                    You have questions?
                                </div>
                        ...
                        <div class="flex items-end gap-3.5 px-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <div
                                    class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
                                    I have checked the features, can not wait
                                    to demo them!
                                </div>
                                <span class="text-xs font-medium text-muted-foreground">
                                    14:26
                        ...
                        <div class="flex items-end justify-end gap-3.5 px-5">
                            <div class="flex flex-col gap-1.5">
                                <div class="kt-card shadow-none flex bg-primary flex-col gap-2.5 p-3 rounded-be-none">
                                    <p class="text-2sm font-medium text-primary-foreground">
                                        Haven't seen the build yet, I'll
                                        look now.
                                    </p>
                                </div>
                                <div class="flex items-center justify-end gap-2 relative">
                        ...
                        <div class="flex items-end gap-3.5 px-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <div
                                    class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
                                    Tomorrow, I will send the link for the
                                    meeting
                                </div>
                                <span class="text-xs font-medium text-muted-foreground">
                                    17:40
                        ...
                        <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start"
                            ...
                            <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
                                <ul class="kt-dropdown-menu-sub">
                                    ...
                                    <li>
                                        <a class="kt-dropdown-menu-link"
                                            href="html/demo2/account/home/user-profile.html">
                                    ...
                                    <li>
                                        <a class="kt-dropdown-menu-link"
                                            href="html/demo2/account/security/overview.html">
